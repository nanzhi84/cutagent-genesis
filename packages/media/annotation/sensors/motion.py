...
class MotionGuard:
    ...
    def __init__(
        self,
        *,
        portrait_edge_window: float = 1.5,
        motion_guard_enabled: bool = True,
        motion_guard_sample_fps: float = 12.0,
        motion_guard_width: int = 360,
        motion_guard_active_px: float = 2.2,
        motion_guard_hard_px: float = 6.0,
        motion_guard_p95_hard_px: float = 9.0,
        motion_guard_tail_y_range_hard_px: float = 40.0,
        motion_guard_tail_net_y_hard_px: float = 26.0,
        motion_guard_smooth_move_straightness: float = 0.82,
        motion_guard_smooth_move_flip_ratio: float = 0.18,
        motion_guard_sweep_axis_ratio: float = 3.0,
        motion_guard_jitter_flip_ratio: float = 0.34,
        motion_guard_jitter_jerk_ratio: float = 0.9,
